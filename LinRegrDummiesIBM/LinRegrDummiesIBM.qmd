...
We survey 1,000 people age 50 and ask how many offsprings their mother had.
...
summary(ModelLMExpSex)
```

Education matters also **and** sex samples (fem/male) are biased in regards of education.

Second best (since AB Test is not possible) solution: 

-  Controll for the impact of $Educ$ on $Wage$
