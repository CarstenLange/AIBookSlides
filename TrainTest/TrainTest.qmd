...
**Run the 10 Steps to Tune a Polynomial Model:**

[Here is a link for the exercise to tune a Polynomial Model for real estate price prediction](https://aibookslides.netlify.app/aibookexercises/06-traintestexerc200){target=_blank}


**Other Interactive Exercises from the Textbook**

[Here is a link for for exercises from Practical Machine Learning with R](https://ai.lange-analytics.com/exercises){target=_blank}
