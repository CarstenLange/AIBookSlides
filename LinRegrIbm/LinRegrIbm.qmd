...
Find values for $\beta_1$ and $\beta_2$ that minimize the individual prediction errors $$(\widehat{y}_{i}-y_i)^2$$
...
Copy the code at the end of the slide into an *R* script and try to adjust $\beta_1$ and $\beta_1$ to get the best prediction equation.
...
Find values for $\beta_0$ and $\beta_1$ that minimize the individual prediction errors: 
$$(\widehat{y}_{i}-y_i)^2$$
$$(\widehat{Grade}_{i}-Grade_i)^2$$
:::
...
## How to Measure Prediction Quality {.smaller .scrollable}
