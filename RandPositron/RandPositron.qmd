...
format: 
  live-revealjs:
    ...
    incremental: false
    scrollable: true
    footer: "<a href='https://ai.lange-analytics.com/htmlbook/RAndRStudio.html' target='_blank'>Textbook</a>"
...
Example: How to install the tidyverse package: [Click here](https://youtu.be/tAGoThXF2Os){target="_blank"}

Video about the rio package: [Click here](https://youtu.be/8N_5sR4s8XE){target="_blank"}
...
Daily chance of being struck by lightning at any U.S. location is: $0.000000000365$.
