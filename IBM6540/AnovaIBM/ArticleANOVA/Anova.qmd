...
author: "Carsten Lange, <br> Cal Poly, Pomona"
format: 
  html:
...
Each observation shows for different web design scenarios how many conversions resulted within 1 hour. The first 6 records are shown n @tbl-firstsix:
...
kbl(FancyOutput, caption = "Ammended anova() Output") |> 
