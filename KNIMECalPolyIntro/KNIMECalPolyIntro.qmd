...
**Part 1:** A basic example to compare means from two samples
</br></br>

**Part 2:** A linear regression --- Wage Discrimination in 1976
</br></br>
...
**We saw:** Female wages were lower in 1976 than male wages and that the result was most likely (95%) **not derived by chance**.
<br><br>
**Was this wage gap created by discrimination or by a lack of female education and experience?**
<br><br>
To answer this question we have to control for education and experience (in years) --- we have to perform a **regression analysis**
...
$$
Wage=\beta_1 Sex_{Fem}+\beta_2 Exp + \beta_3 Educ +\beta_0
$$ **Advanced Wage Regression:**

$$
ln(Wage)=\beta_1 Sex_{Fem}+\beta_2 Exp^2 + \beta_3 Educ+ 
         \beta_4 MSA_{Yes} +\beta_0
$$
<br><br>
[Load workflow from KNIME Community Hub]{style="color:yellow; font-weight:bold"}
