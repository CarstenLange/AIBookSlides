...
author:
  ...
  affiliation: "California State Polytechnic University, Pomona<br><br>
  **Follow along:** https://ai.lange-analytics.com/dhc.html"
...
## Word Embedding to Provide Meaning/Sementic
...
**Example 2:** the word **it** points to **street**.
...
## Multi Head Processing (Visualization from Google)
...
::: {.callout-note title="This is the only topic we cover" style="background-color:white; color:black; border-left:4px solid black;" }
<strong style="color: black;">Supervised Learning</strong>
:::
...
<strong style="color: black;">Transfer Learning</strong>
...
## Demo 1: Prompt Engeneering (Human Writer)

Left upper corner: Edit GPT
Goto Configure

## Demo 2: Machine Learning Book Analyzer

[https://ai.lange-analytics.com](https://ai.lange-analytics.com)

## Demo 3: Machine Learning Book

CANVAS Course: Advising and content help

## Demo 4: Googles Homework Cheater

quiz is at c:/calpoly/ec322/HomeworkQLive