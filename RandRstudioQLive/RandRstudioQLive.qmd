...
DataTitanic=import("Data/Titanic.csv") |> 
            ...
            filter(Sex=="female")
MeanFareWomen=mean(DataTitanic$FareInDollars)
print(MeanFareWomen)
```
...
DataTitanic=pd.read_csv("Data/Titanic.csv") \
            .rename(columns={"Survived": "Surv"}) [["Sex", "FareInPounds", "Surv"]] \
            .assign(FareInDollars=lambda df: df["FareInPounds"]*164.5) \
            .query("Sex=='female'")
MeanFareWomen=DataTitanic["FareInDollars"].mean()
print(MeanFareWomen)     
```
...
```{pyodide}
import polars as pl
DataTitanic=pl.read_csv("Data/Titanic.csv", infer_schema_length=None) \
