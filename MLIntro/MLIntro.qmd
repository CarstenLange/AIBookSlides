...
::: nonincremental
- Predict tomorrows weather based on todays barometric change of pressure.
...
## Parameters
  The $\beta s$ of a model are the parameters. The parameters are deterined by the optimizer of a machine learning algorithm. 
