...
## Body Temperature  Smaller 100F for Healthy Adults {.smaller}
...
cat("Probability (rounded) for a body temperature smaller than 100F:")
cat("P =",P)
```
...
## Body Temperature Greater 100F for Healthy Adults {.smaller}
...
cat("Probability (rounded) for a body temperature greater than 100F:")
cat("P =",P)
```
...
cat("Probability (rounded) for a body temperature smaller than 98.4F:")
cat("P2 =",P2)
P1=pnorm4(98, 98.2, 0.7)
cat("Probability (rounded) for a body temperature smaller than 98F:")
cat("P1 =",P1)
cat("--------------------------------------------")
cat("P2 - P1:", P2 - P1)
```
...
## Body Temp. "Not Exceeded" by 95% of Healthy Adults {.smaller}
...
## Body Temperature "Exceeded" by 1% of Healthy Adults {.smaller}
