...
format: 
  live-revealjs:
    ...
    incremental: false
    scrollable: true
    footer: "<a href='https://medium.com/data-science/using-causal-ml-instead-of-a-b-testing-eeb1067d7fc0'>Textbook </a> "
webr:
  packages:
    - rio
...
::: footer
[Source: Samuele Mazzanti, Using Causal ML Instead of A/B Testing, Medium](https://medium.com/data-science/using-causal-ml-instead-of-a-b-testing-eeb1067d7fc0){target="_blank"}
:::
