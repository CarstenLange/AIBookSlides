...
Video for *First Steps* to setup *R* and *RStudio*: [Click here](https://youtu.be/LmRtTkD5E6M)</br>
...
1. `CTRL SHIFT P` (Windows) or `⌘ SHIFT P` (Mac) to open *Command Pallette*
