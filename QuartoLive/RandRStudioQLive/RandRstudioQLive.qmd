...
-   How to extend R's functionality with R-packages, whichvpackages to install
...
### not recommended (outdated) {.smaller}

![RStudio Window](Graphics/RStudioWindowsCL.png)

First steps to setup *R* and *RStudio* can be found in this video: [Click here](https://youtu.be/LmRtTkD5E6M)</br>
...
## Always Open or Create Folder {.smaller}
...
## Create a New `R` or `Quarto` file

1. `CTRL SHIFT P` or `⌘ SHIFT P` to open *Command Pallette*
2. Type either "New Quarto Document" or  "New R Document" into search bar
3. Click and Create file
4. Save file right away


## Open a File from Your Folder {.smaller}
