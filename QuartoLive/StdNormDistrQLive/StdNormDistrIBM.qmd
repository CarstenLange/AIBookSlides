...
**0.95 Confidence Interval:** <br> $Mean \pm 1.96 \cdot StdDev$ <br> In this example $230.5 - 50 \cdot 1.96= 132.5$ and $230.5 + 50\cdot 1.96= 328.5$ <br> 95% of all 45 - 54 year women have a Cholesterol level higher than 182.5 and lower than 378.5.
...
`pnorm(x, mean=?, sd=?)` calculates the probability of getting a value smaller than x. <br> **Try:** What is the probability of having a value of less than 200 when the mean is 230.5 and the standard deviation is 50.
