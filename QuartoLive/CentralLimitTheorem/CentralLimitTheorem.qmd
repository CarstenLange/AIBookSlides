...
A survey of 50 customers from a branch leads to average sentiment score of 72 (inches)scale 0 - 100). It is known that the Mean for all customers is $70$ and the Standard Deviation is $3$.
...
**So, by how much would the *Sample Mean* spread, if we considered surveys?**
<br>
