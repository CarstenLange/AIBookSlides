...
::: {.incremental}
-   Who runs faster, men or women? (true for all men and women?)

-   Who is taller, men or women? (true for all men and women?)

-   What is it the average temperature in Michigan/Coastal California?

-   Which of your products shows high or low volatility in sales? (Why and why is it important?)
:::
...
## How are Critical Diabetes Values and other Blood Test Values Determined {.smaller}
...
For women 45 -- 54 years, the mean is 230.5 mg/100 ml, and the standard deviation is 50.0 (source: <https://www.cdc.gov/nchs/data/series/sr_11/sr11_022.pdf>)
