...
- You will review the concept of standard deviation
...
**Download:** with rio::import


Female Data:

import("https://ai.lange-analytics.com/data/DataUSArmyBodyMeasures.xlsx", sheet=DataFemale)

Male Data:

import("https://ai.lange-analytics.com/data/DataUSArmyBodyMeasures.xlsx", sheet=DataMale)
...
library(janitor)
library(tidymodels)
DataSoldiersM=import("C:/CalPoly/RSamples/Data/DataUSArmyBodyMeasures.xlsx", sheet="DataMale")|> 
              clean_names("upper_camel") |> 
              select(Height=Heightin, Weight=Weightlbs, Gender)
DataSoldiersF=import("C:/CalPoly/RSamples/Data/DataUSArmyBodyMeasures.xlsx", sheet="DataFemale")|> 
              clean_names("upper_camel") |> 
              select(Height=Heightin, Weight=Weightlbs, Gender)
