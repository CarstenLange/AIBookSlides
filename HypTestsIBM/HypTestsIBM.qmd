...
## Example: Statistic $\beta_1$ for a Sample of N=100 for a Univariate Regression set.seed(123)
...
$SE_{\beta_1}$ measures the spread of the 

## Example: Statistic $\beta_1$ for a Sample of N=100 for a Univariate Regression set.seed(321)
...
## How Can R Estimate the SE for $\beta_1$ Based on only One Sample?
...
## Coefficient of Determination - SSR (sum of squares, errors)
...
**$R^2$ is the proportion of explained variance of the dependend variable.**
