...
See the two diagrams on Wikipedia to see the difference of 

- the Sum of Squares total (SST)

- Sum of Squared Errors from the Regression or Sum of Squared Residuals (SSR)
...
$$R^2=1 - \frac{SSR}{SST}=\frac{
\overbrace{SSR-SSE}^{\mbox{Expl. Sum of Squares}}
}{SST}=\frac{
