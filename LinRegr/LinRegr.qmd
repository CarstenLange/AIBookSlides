...
set.seed(7771)
DataHouses=sample_n(DataHouses,100)
head(DataHouses)
...
<https://econ.lange-analytics.com/calcat/linregrmeans>{target="_blank"}

## Same Data with Tidymodels

```{r}
RecipeHouses= recipe(Price~Sqft, data=DataHouses)
