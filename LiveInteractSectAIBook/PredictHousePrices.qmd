...
::: {.hint exercise="ex_1"}
I think the answer is probably 2
:::

::: {.solution exercise="ex_1"}
Here is the Solution: it is not 2
...
Please substitute the `______` in the code block below and execute the code. If everything is correct, *R* will print information about the fitted `workflow` model. The printout includes the optimal values for the $\beta s$:
