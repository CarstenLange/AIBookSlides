...
[Neural Network Real World Application](https://aibookslides.netlify.app/scripts/DeepLearnScript1.R)
<br><br>
Alternatively you can run an uncommented R-script with the same code [here](https://aibookslides.netlify.app/scripts/deeplearnscript2.R).
