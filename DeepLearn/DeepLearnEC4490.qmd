...
## Diamnond Price Prediction --- The Data

We will estimate diamond prices based on their physical properties and use the well-known `diamonds` dataset automatically loaded together with `ggplot2`:
...
We use only 10,000 observations to increase optimization speed.
